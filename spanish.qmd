...
<div class="english" style="display: block;"> 
  <h2> I have learned a lot since I started studying Spanish at UCSB two years ago!</h1>
...
<div class="spanish" style="display: none;">
  <h2>¡He aprendido mucho desde que comencé estudiar español en UCSB hace dos años!</h1>
...
description="CPalacio Real de Madrid"}

![](media/el_retiro.jpeg){group="madrid"
description="Parque de El Retiro"}

![](media/real_jardin.jpeg){group="ENVS"
