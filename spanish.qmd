...
![](media/palace.jpeg){.lightbox data-lightbox="madrid"
description="Palacio Real de Madrid"}

![](media/el_retiro.jpeg){.lightbox data-lightbox="madrid"
description="Parque de El Retiro"}

![](media/real_jardin.jpeg){.lightbox data-lightbox="madrid"
description="Real Jardín Botánico"}


![](media/embajadores.jpeg){.lightbox data-lightbox="madrid"
description="Embajadores, Madrid"}

![](media/madrid_sheep.jpeg){.lightbox data-lightbox="madrid"
