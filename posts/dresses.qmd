...
img <- image_read("sewing_images/IMG_3580.jpeg")           # adjust path as needed
img_small <- image_scale(img, "1200x1200")       # scale to max width/height 1200px
image_write(img_small, "sewing_images/IMG_3580_small.jpeg", quality = 85) # save smaller version

```

![](sewing_images/IMG_3580_small.jpeg){.lightbox description="Final rendering of costume design for We Were Light"}

::: {layout="[[1, 1, 1], [1, 1, 1]]"}
![](sewing_images/spring-135.JPG){.lightbox data-lightbox="first"}

![](sewing_images/spring-124.jpg){.lightbox data-lightbox="first"}

![](sewing_images/spring-67.jpg){.lightbox data-lightbox="first"}

![](sewing_images/spring-60.jpg){.lightbox data-lightbox="first"}

![](sewing_images/spring-129.JPG){.lightbox data-lightbox=first"}

![](sewing_images/spring-75.JPG){.lightbox data-lightbox="first"}
:::
...
![](sewing_images/img_3591.jpeg){.lightbox data-lightbox="group0"
description="Final rendering of costume design for The Point Being"}

::: {layout="[1,1]"}
![](sewing_images/IMG_3733.jpeg){.lightbox data-lightbox="craft"
description="Draping process for the point being costumes"}

![](sewing_images/IMG_3760.jpeg){.lightbox data-lightbox="craft"
description="Draping process for the point being costumes"}
:::

::: {layout="[[1,1,1], [1,1,1]]"}
![](sewing_images/spring-252.jpg){.lightbox data-lightbox=tpb"}

![](sewing_images/spring-293.jpg){.lightbox data-lightbox="tpb"}

![](sewing_images/spring-260.jpg){.lightbox data-lightbox="tpb"}

![](sewing_images/spring-233.jpg){.lightbox data-lightbox="tpb"}

![](sewing_images/spring-244.jpg){.lightbox data-lightbox="tpb"}

![](sewing_images/spring-243.jpg){.lightbox data-lightbox="tpb"}
:::
